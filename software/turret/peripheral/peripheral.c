...
void getLags(peripheral_dev *dev, peripheral_lags *lags) {
	...
	lags->t03 = (22 - (temp >> (3 * PERIPHERAL_XCORR_BITS)) & PERIPHERAL_MASK_LAGS) - 11; // Number 2 and 3 seem to be swapped
	lags->t12 = (22 - (temp >> (2 * PERIPHERAL_XCORR_BITS)) & PERIPHERAL_MASK_LAGS) - 11; // at some point
