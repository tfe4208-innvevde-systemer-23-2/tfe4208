...
/* Vertical servo */
#define PANTILT_PWM_V_MIN_DUTY_CYCLE_US (1000)      //  1 ms
#define PANTILT_PWM_V_MAX_DUTY_CYCLE_US (2000)     //  2 ms

/* Horizontal servo */
#define PANTILT_PWM_H_MIN_DUTY_CYCLE_US (1000)     //  1 ms
#define PANTILT_PWM_H_MAX_DUTY_CYCLE_US (2000)    //  2 ms

/* Trigger servo */
#define PANTILT_PWM_T_MIN_DUTY_CYCLE_US (1200)     //  0 ms
#define PANTILT_PWM_T_MAX_DUTY_CYCLE_US (2000)    //  2 ms
