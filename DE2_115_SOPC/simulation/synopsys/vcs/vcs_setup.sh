...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/DE2_115_SOPC_mm_interconnect_0_rsp_demux_001.sv \
  ...
  $QSYS_SIMDIR/submodules/DE2_115_SOPC_pio_led.v \
  $QSYS_SIMDIR/submodules/DE2_115_SOPC_onchip_memory2.v \
